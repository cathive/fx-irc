...
import com.cathive.fx.irc.jerklib.events.WhoisEvent;
...
public class WhoisParser implements CommandParser
{
	...
	public IRCEvent createEvent(IRCEvent event)
	{
		switch (event.numeric())
		{
			...
			{
				// "<nick> :{[@|+]<channel><space>}"
				// :kubrick.freenode.net 319 scripy mohadib :@#com.cathive.fx.irc.jerklib
				// kubrick.freenode.net 319 scripy mohadib :@#com.cathive.fx.irc.jerklib ##swing
				if (we != null )
				{
